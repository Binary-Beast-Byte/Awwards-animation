...
import { slideTitles } from "./constant";

export const TrippyIndex = () => {
  useEffect(() => {
    ...
    function createSlides() {
      for (let i = 0; i < totalSlides * 3; i++) {
        ...
        img.src = `/blurred/${imageNumber}.webp`;
    ...
    function updateThumbnailItems() {
      ...
      const currentRotationAngle =
        -(exactSlideProgress * (360 / totalSlides)) + 90;
  ...
  return (
    <div>
      <div className="slider">
        <p className="slide-title">Frozen Echo</p>
      </div>
